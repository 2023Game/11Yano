...
bool Renderer::initDeviceAndSwapChain(HWND hWindow)
{
	...
	sd.Flags = DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH;//モード自動切換
...
bool Renderer::initBackBuffer()
{
	...
	hr = pSwapChain_->GetBuffer(0, //バック・バッファの番号
	...
	hr = pD3DDevice_->CreateRenderTargetView(pBackBuffer,//ビューでアクセスするリソース
